...
public class OrderServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            contact=request.getParameter("usercontact");
            address=request.getParameter("useraddress");
           
            
            HttpSession httpSession =request.getSession();
            
                if(name.isEmpty() || email.isEmpty()  || contact.isEmpty() || contact.length()>10 || address.isEmpty()){
                httpSession.setAttribute("message","Feilds Empty Or Invalid");
